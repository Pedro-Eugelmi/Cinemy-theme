...
function theme_enqueue_scripts() {
    ...
    // Scripts
    wp_enqueue_script('bootstrap_js', get_template_directory_uri() . '/scripts/bootstrap.bundle.min.js', array(), filemtime(get_template_directory() . '/scripts/bootstrap.bundle.min.js'), true);
